...
@section('title','Edit category cultural guide')
@section('content')

<div id="create-cat-guide" class="container page country-page route">
	<div class="head">
		<a href="{{ route('catCulturalsAdmin') }}" class="back-icon"><i class="fa fa-angle-left" aria-hidden="true"></i> All category cultural guide</a>
		<h1 class="title">Edit category cultural guide</h1>		
	</div>	
	<div class="main">
		<form action="{{route('updateCatCulturalAdmin', $cat_guide->slug)}}" class="frm-menu dev-form activity-form" method="POST" role="form">
			{!!csrf_field()!!}
			<input type="hidden" name="post_type" value="cultural">
			<div class="row">
				...
				<div class="col-md-3 sidebar">
					...
					<div class="group-fixed">
						<div class="group-action">
							...
							<a href="{{route('catCulturalsAdmin')}}" class="btn btn-cancel">Cancel</a>									
						</div>
					</div>
				</div>
			</div>			
