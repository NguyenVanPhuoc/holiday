...
@section('title','Add category cultural guide')
@section('content')
<div id="create-cat-guide" class="container page country-page route">
	<div class="head">
		...
		<h1 class="title">Add category cultural guide</h1>		
	</div>	
	<div class="main">
		<form action="{{route('createCatCulturalAdmin')}}" class="frm-menu dev-form activity-form" method="POST" role="form">
			{!!csrf_field()!!}
