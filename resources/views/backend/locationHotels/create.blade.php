...
@section('title','Add location hotel')
@section('content')
<div id="create-location" class="container page route">
	<div class="head">
		<a href="{{route('starRatingsAdmin')}}" class="back-icon"><i class="fa fa-angle-left" aria-hidden="true"></i> All location hotel</a>
		<h1 class="title">Add location hotel</h1>		
	</div>
	<div class="main">
		<div class="row">
...
<script type="text/javascript">
	$(function() {
		$("#create-location").on('click','form .group-action button',function(){
			...
			if(title==""){
				...
				$.ajax({
					type:'POST',            
					url:'{{ route("createLocationHotelAdmin") }}',
					cache: false,
					data:{
						'_token': _token,
						'title': title,
