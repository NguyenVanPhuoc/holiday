...
@section('title','Edit Cultural Guide')
@section('content')
...
<div id="edit-cultural" class="page route">
	<div class="head">
		<a href="{{route('culturalsAdmin')}}" class="back-icon"><i class="fa fa-angle-left" aria-hidden="true"></i> All cultural guides</a>
		<h1 class="title">Edit Cultural Guide</h1>		
	</div>
	<div class="main">
		<form action="{{ route('updateCulturalAdmin', $guide->id) }}" method="post" class="dev-form activity-form">
			{!!csrf_field()!!}
			<div class="row">
					...
					<div class="group-fixed">
						<section id="sb-action">
							<div class="group-action">
								<a href="{{ route('deleteCulturalAdmin', ['id'=>$guide->id]) }}" class="btn btn-delete delete-item">Delete</a>
