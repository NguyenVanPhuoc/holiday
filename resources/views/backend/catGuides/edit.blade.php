...
@section('title','Edit category travel tips')
@section('content')
...
<div id="create-cat-guide" class="container page country-page route">
	<div class="head">
		...
		<h1 class="title">Edit category travel tips</h1>		
	</div>	
	<div class="main">
		<form action="{{route('updateCatGuideAdmin', $cat_guide->slug)}}" class="frm-menu dev-form activity-form" method="POST" role="form">
			{!!csrf_field()!!}
