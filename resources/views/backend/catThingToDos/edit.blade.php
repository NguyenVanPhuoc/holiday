...
@section('title','Edit category thing to do')
@section('content')
...
<div id="create-cat-guide" class="container page country-page route">
	<div class="head">
		...
		<h1 class="title">Edit category thing to do</h1>		
	</div>	
	<div class="main">
		<form action="{{route('updateCatThingToDoAdmin', $cat_guide->slug)}}" class="frm-menu dev-form activity-form" method="POST" role="form">
			{!!csrf_field()!!}
					...
					<div class="row form-group">
						...
						<div class="col-md-2">
							...
							<div id="frm-green-icon" class="desc img-upload">							
								<div class="image">
									<a href="{{ route('loadMedia') }}" class="library"><i class="fa fa-edit" aria-hidden="true"></i></a>
									{!!image($cat_guide->yellow_icon, 150,150, 'Image')!!}
									<input type="hidden" name="yellow_icon" class="thumb-media" value="{{ $cat_guide->yellow_icon }}" />
								</div>
							</div>
						</div>
						<div class="col-md-2">
