...
@section('title','Add Countries Places to visit')
@section('content')
<div id="create-country-blog" class="container page route">
	<div class="head">
		...
		<h1 class="title">Add countries Places to visit</h1>		
	</div>
	<div class="main">
		<form action="{{route('createCountryPlacesAdmin')}}" class="frm-menu dev-form activity-form" method="POST" name="create_country_places" role="form">
			{!!csrf_field()!!}
			<div class="row">
