...
@section('title','Add Countries Tour')
@section('content')
<div id="create-country-blog" class="container page route">
	<div class="head">
		...
		<h1 class="title">Add countries Tour</h1>		
	</div>
	<div class="main">
		<form action="{{route('createCountryTourAdmin')}}" class="frm-menu dev-form activity-form" method="POST" name="create_country_tour" role="form">
			{!!csrf_field()!!}
			<div class="row">
