...
@section('title','Edit Country Tour')
@section('content')
<div id="edit-countries-blog" class="container page route">
	<div class="head">
		<a href="{{route('countryTourAdmin')}}" class="back-icon"><i class="fa fa-angle-left" aria-hidden="true"></i> Countries Tour</a>
		<h1 class="title">Edit Countries Tour</h1>		
	</div>
	<div class="main">
		<form action="{{route('updateCountryTourAdmin', $countries->id)}}" class="frm-menu dev-form activity-form" method="POST" name="create_country_tour" role="form">
			{!!csrf_field()!!}
			<div class="row">
				...
				<div class="col-md-3 sidebar">
					...
					<div class="group-fixed">
						<div class="group-action">
							<a href="{{route('deleteCountryTourAdmin', $countries->id)}}" class="btn btn-delete">Delete</a>
							<button type="submit" name="submit" class="btn">Save</button>
							<a href="{{route('countryTourAdmin')}}" class="btn btn-cancel">Cancel</a>							
						</div>
					</div>
				</div>
			</div>	
