...
@section('title','Add Countries Guide')
@section('content')
<div id="create-country-blog" class="container page route">
	<div class="head">
		...
		<h1 class="title">Add countries Guide</h1>		
	</div>
	<div class="main">
		<form action="{{route('createCountryGuideAdmin')}}" class="frm-menu dev-form activity-form" method="POST" name="create_country_guide" role="form">
			{!!csrf_field()!!}
			<div class="row">
