...
<div id="edit-countries-blog" class="container page route">
	<div class="head">
		<a href="{{route('countryGuideAdmin')}}" class="back-icon"><i class="fa fa-angle-left" aria-hidden="true"></i> Countries Guide</a>
		<h1 class="title">Edit Countries Guide</h1>		
	</div>
	<div class="main">
		<form action="{{route('updateCountryGuideAdmin', $countries->id)}}" class="frm-menu dev-form activity-form" method="POST" name="create_country_guide" role="form">
			{!!csrf_field()!!}
			<div class="row">
				...
				<div class="col-md-3 sidebar">
					<div class="gr-not-fixed">
						...
						<section id="sb-image-essential" class="box-wrap">
							<h2 class="title">Essential Tips-Guide Banner</h2>
							<div id="frm-image-essential" class="desc img-upload">							
								<div class="image">
									<a href="{{ route('loadMedia') }}" class="library"><i class="fa fa-edit" aria-hidden="true"></i></a>
									{!!image($countries->img_plant, 150,150, 'Image')!!}
					...
					<div class="group-fixed">
						<div class="group-action">
							<a href="{{route('deleteCountryGuideAdmin', $countries->id)}}" class="btn btn-delete">Delete</a>
							<button type="submit" name="submit" class="btn">Save</button>
							<a href="{{route('countryGuideAdmin')}}" class="btn btn-cancel">Cancel</a>							
						</div>
					</div>
				</div>
			</div>	
