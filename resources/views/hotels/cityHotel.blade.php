@php
	$meta_key = $city->title . ' accommodation';
	$meta_value = 'The collection of ' . $city->title . ' accommodation including hotels, guesthouse, B&Bs, Lodges, or homestay. Filter for your favorite location or facilities of your stay';
	$title_tag = $city->title . ' accommodation: hotels, guesthouses, B&Bs, Lodges, or homestay';	

	$bg_img = getImgUrl($city->image, $city->title); 
	$icon_top = asset('public/images/icons/all/hotel2-white.png');
	$breadcrumb = Breadcrumbs::render('cityHotel', $country, $region, $city->title);
	$title_top_h1 = $city->title . ' accommodation';
	...
	<div class="section">
		<div class="container">
			<div class="hotel-content wrap-result">
				{!!csrf_field()!!}
				<input type="hidden" name="current_country" value="{{ $city->id }}">
