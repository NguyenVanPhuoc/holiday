@php 
    ...
    $bg_looking= getImgUrl(getDsMetas(329));
    $bg_request= getImgUrl(getDsMetas(330));
...
@section('content')
<div id="term_of_use" class="page bg-gray singe-post booking_conditions one-page">
    ...
    @desktop
        <a href="{!! getDsMetas(183) !!}" download class="download"><img src="{{asset('public/images/download.png')}}" alt="image">&nbsp;Download in PDF</a>
    @enddesktop
    <div class="container">
            <div class="top-intro text-center">{!! getDsMetas(182) !!}</div>
        </div>
