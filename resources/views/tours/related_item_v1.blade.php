<div class="col-md-6 col-sm-6 col-pd">
	@php
	...
	<div class="item">
	    <div class="image">
	        ...
	        <div class="hover_tour">
	            @if($countCountry==1)
                    <a class="link" href="{{ route('tour', ['slug_country'=>$country->slug , 'slug'=>$tour->slug]) }}"></a>
	            	<p class="name white"> - {{ $country->title }} -</p>
                @else
	    ...
	    <div class="desc light-graybg">
	        ...
	        <a href="{{ route('tour', ['slug_country'=>$country->slug , 'slug'=>$tour->slug]) }}">More</a>
	    </div>
	</div>
	@elsedesktop
	<div class="item">
