@php 
    ...
    $bg_looking= getImgUrl(getDsMetas(327));
    $bg_request= getImgUrl(getDsMetas(328));
...
<div id="term_of_use" class="page bg-gray singe-post privacy_policy one-page">
    ...
    @desktop
        <a href="{!! getDsMetas(326) !!}" download class="download"><img src="{{asset('public/images/icons/biig_club/pdf.png')}}" alt="image">&nbsp;Download in PDF</a>
    @enddesktop
    	<div class="container">
            <div class="top-intro text-center">{!! getDsMetas(179) !!}</div>
        </div>
