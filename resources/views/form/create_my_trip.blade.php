@php 
    ...
    $breadcrumb = Breadcrumbs::render('FAQs', 'Request a free quote');
    $title_top_h1 = 'Request a free quote';
@endphp
...
@section('content')
<div id="createMyTrip-page" class="page form-page bg-gray singe-post page-only createMyTrip">
                ...
                <div class="row">
                    ...
                    <div id="content" class="col-md-9 content-right">
                        ...
                        <div class="form light-graybg">
                            <div class="box">
                                <form id="createMyTrip-frm" autocomplete="off" action="#" method="POST" data-toggle="validator" role="form" name="contact" class="dev-form frm-createMyTrip">
                                    {{csrf_field()}}
                                    <input type="hidden" autocomplete="false" name="url-frm" value="{{route('updateCreateMyTrip')}}">
                                    ...
                                    @if(isset($list_destination))
                                        <div id="frm-destination">
                                            <label for="destination" class="control-label">Place(s) to visit<span class="pink">*</span></label>
                                    ...
                                    @if(isset($list_tour_style))
                                        <div id="frm-tourType">
                                            <label for="tourType" class="control-label">Tour style(s)<span class="pink">*</span></label>
                                            <p>Choose 3 maximum</p>
                                            <div class="row custom-checkbox">
                                                @foreach($list_tour_style as $item)
                                                    <div class="col-md-4 check-req">
                                                        <div class="selected">
                                                           <div class="checkbox checkbox-2">
                                                                <input type="checkbox" name="tourType[]" id="tourType" value="{{ $item->title }}" required>
                                                                <span>{{ $item->title }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div id="frm-otherDest" class="form-group">
                                        <label for="otherDest" class="control-label">Describe your project and outlook of the trip<span class="pink">*</span></label>
                                        <textarea name="otherDest" id="otherDest" class="form-control" placeholder="To have contact with the local people? To learn more about local culture? or..." required></textarea>
                                    </div>
                                    ...
                                    <div id="frm-budgetPerson" class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <p>Your total estimated expense: <span class="pink">USD 0.00 </span> (excluding international flight)</p>
                                    </div>   
                                    ...
                                    <div id="frm-sponsor" class="form-group">
                                        ...
                                        <div class="row">
                                            <div id="frm-titleIntro"  class="col-md-3 has-feedback">
                                                <div class="wrap-select">
                                            ...
                                            <div id="frm-fullNameIntro" class="col-md-9 has-feedback">
    ...
    <div class="life-nvp" style="background-image: url('{!! getImgUrl(getDsMetas(319)) !!}');">
        <div class="container">
            <h2 class="title-life"><span>{!! getDsMetas(318) !!}</span></h2>
        </div>
    </div>
    <!-- Modal -->
