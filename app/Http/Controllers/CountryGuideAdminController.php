...
class CountryGuideAdminController extends Controller
{
	public function index(){    	
    	$countries = CountryBlog::latest()->where('type', 'country_guide')->paginate(15);    	
    	return view('backend.guideCountry.list_country_guide',['countries'=>$countries]);
    }
    ...
    public function store(){   
    	...
    	return view('backend.guideCountry.create_country_guide',$data);
    }
    ...
    public function edit($id){
    	...
    	return view('backend.guideCountry.edit_country_guide',['countries'=>$countries, 'seo'=>$seo , 'list_country'=>$list_country]);
    }
    ...
    public function update(Request $request, $id){    	
        ...
        return response()->json(['success' => 'Update to success.', 'url' => route('updateCountryGuideAdmin', $id)]);
    }
	...
	public function delete($id){
        ...
        $countries = CountryBlog::find($id);
        $countries->delete();
        return redirect()->route('countryGuideAdmin')->with('success','Deleted successfull');
    }
}
