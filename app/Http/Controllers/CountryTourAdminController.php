...
class CountryTourAdminController extends Controller
{
	public function index(){    	
    	$countries = CountryBlog::latest()->where('type', 'country_tour')->paginate(15);    	
    	return view('backend.tourCountry.list_country_tour',['countries'=>$countries]);
    }
    ...
    public function store(){   
    	...
    	return view('backend.tourCountry.create_country_tour',$data);
    }
    ...
    public function edit($id){
    	...
    	return view('backend.tourCountry.edit_country_tour',['countries'=>$countries, 'seo'=>$seo , 'list_country'=>$list_country]);
    }
    ...
    public function update(Request $request, $id){    	
        ...
        return response()->json(['success' => 'Update to success.', 'url' => route('updateCountryTourAdmin', $id)]);
    }
	...
	public function delete($id){
        ...
        $countries = CountryBlog::find($id);
        $countries->delete();
        return redirect()->route('countryTourAdmin')->with('success','Deleted successfull');
    }
}
